 <template>
    <div class="rating_page">
        <head-top head-title="在线支付" :go-back='true' :sign-up="true"></head-top>
...
import { payRequest } from 'api/index'
...
export default {
	...
	methods: {
		...
		//初始化信息
		initData() {
            payRequest(this.orderMessage.order_id, this.userInfo.user_id)
                .then((res) => {
